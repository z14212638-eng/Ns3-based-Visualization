...
main(int argc, char* argv[])
{
    ...
    apNodes.Get(0)->GetObject<MobilityModel>()->SetPosition(Vector(5.3268, 3.69821, 4.02619));

    // STA Positions
    mobility.Install(staNodes);
    staNodes.Get(0)->GetObject<MobilityModel>()->SetPosition(Vector(3.74025, 0.598919, 1.53935));
