...
main(int argc, char* argv[])
{
    ...
    apNodes.Get(0)->GetObject<MobilityModel>()->SetPosition(Vector(6.05916, 2.4272, 2.64605));
    apNodes.Get(1)->GetObject<MobilityModel>()->SetPosition(Vector(6.05916, 2.4272, 2.64605));

    // STA Positions
    mobility.Install(staNodes);
    staNodes.Get(0)->GetObject<MobilityModel>()->SetPosition(Vector(7.31959, 1.97275, 4.99825));
